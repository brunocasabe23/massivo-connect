          ...
          {loading ? (
            Array.from({ length: 5 }).map((_, index) => (
              <TableRow key={`loading-${index}`}>
                ...
                <TableCell><Skeleton className="h-4 w-16" /></TableCell> {/* Ajustado para 5 columnas visibles */}
            ...
            <TableRow>
              <TableCell colSpan={7} className="h-24 text-center text-red-500"> {/* Ajustado colSpan */}
                Error: {error}
              </TableCell>
            </TableRow>
          ) : users.length === 0 ? (
            <TableRow>
              <TableCell colSpan={7} className="h-24 text-center"> {/* Ajustado colSpan */}
